TEMPLATE = app
TARGET = litecoindark-qt
macx:TARGET = "LitecoinDark-Qt"
VERSION = 1.1.2.13
...
QMAKE_CXXFLAGS += -U_FORTIFY_SOURCE -D_FORTIFY_SOURCE=2 -std=c++1y
...
macx:ICON = src/qt/res/icons/litecoindark.icns
